...
public class RunRoboSim {

    RobocodeEngine engine;
    BattlefieldSpecification battlefield;
    BattleObserver battleObserver;

    final static int Handicap = GenAlg.Handicap;

    public RunRoboSim(){
        engine = new RobocodeEngine(new java.io.File("Users/glennhealy/robocode/"));
    ...
    public double[] runGroupings(String bots[], String samples[], int rounds){
        engine = new RobocodeEngine(new java.io.File("Users/glennhealy/robocode/"));
        ...
        for(int i = 0; i < bots.length; i++){
            ...
            for(int j = 0; j < samples.length; j++){
                ...
                double roundFitness = (botScore + Handicap)/(totalScore+ Handicap);
